...
This project is an end-to-end **Senior Growth Analytics project** designed to demonstrate how marketing, CRM, and product usage data can be integrated to evaluate performance across the customer journey.
